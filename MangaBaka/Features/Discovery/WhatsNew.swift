...
enum ReleaseNotes {
    ...
    static let current = Release(
        ...
        items: [
            ...
            "Tap a publisher or studio on a series page to see everything they make, "
                + "most popular or newest first",
            "\"Popularity\" now sorts most popular first — it was backwards",
